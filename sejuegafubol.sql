...
--
-- Name: locations_location_id_seq; Type: SEQUENCE; Schema: public; Owner: me
--
...
ALTER TABLE public.locations_location_id_seq OWNER TO me;

--
-- Name: locations_location_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: me
--
...
--
-- Name: matches; Type: TABLE; Schema: public; Owner: me
--
...
ALTER TABLE public.matches OWNER TO me;

--
-- Name: matches_matches_id_seq; Type: SEQUENCE; Schema: public; Owner: me
--
...
ALTER TABLE public.matches_matches_id_seq OWNER TO me;

--
-- Name: matches_matches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: me
--
...
--
-- Name: players_matches; Type: TABLE; Schema: public; Owner: me
--
...
ALTER TABLE public.players_matches OWNER TO me;

--
-- Name: relationship; Type: TABLE; Schema: public; Owner: me
--
...
ALTER TABLE public.relationship OWNER TO me;
...
--
-- Name: locations location_id; Type: DEFAULT; Schema: public; Owner: me
--
...
--
-- Name: matches match_id; Type: DEFAULT; Schema: public; Owner: me
--
...
--
-- Data for Name: locations; Type: TABLE DATA; Schema: public; Owner: me
--
...
--
-- Data for Name: matches; Type: TABLE DATA; Schema: public; Owner: me
--
...
--
-- Data for Name: players_matches; Type: TABLE DATA; Schema: public; Owner: me
--
...
--
-- Data for Name: relationship; Type: TABLE DATA; Schema: public; Owner: me
--
...
COPY public.users (user_id, name, email, last_name) FROM stdin;
\.


--
-- Name: locations_location_id_seq; Type: SEQUENCE SET; Schema: public; Owner: me
--
...
--
-- Name: matches_matches_id_seq; Type: SEQUENCE SET; Schema: public; Owner: me
--
...
--
-- Name: matches matches_pkey; Type: CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: players_matches players_matches_pkey; Type: CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: relationship relationship_pkey; Type: CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: matches matches_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: players_matches players_matches_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: players_matches players_matches_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: relationship relationship_action_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: relationship relationship_user_one_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
...
--
-- Name: relationship relationship_user_two_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: me
--
